 ...
 */
$config_directories = array(
  CONFIG_SYNC_DIRECTORY => '../config/stevie'
);
...
if (isset($_ENV['AH_SITE_ENVIRONMENT'])) {
  ...
  $secrets_file = sprintf(
    '/mnt/gfs/%s.%s/nobackup/stevie.secrets.settings.php',
    $_ENV['AH_SITE_GROUP'],
...
if (isset($_ENV['AH_SITE_ENVIRONMENT'])) {
  ...
  switch ($_ENV['AH_SITE_ENVIRONMENT']) {
    ...
    case 'test':
      // Staging environment.
      $conf['acquia_purge_domains'] = array(
        'stevie.cmsstage.uwmedicine.org',
      );
      break;
    case 'dev':
      // Staging environment.
      $conf['acquia_purge_domains'] = array(
        'stevie.cmsdev.uwmedicine.org',
      );
      break;
    case 'ra':
      // RA environment.
      $conf['acquia_purge_domains'] = array(
        'stevie.cmsra.uwmedicine.org',
      );
      break;
    default:
