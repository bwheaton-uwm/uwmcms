...
(function ($, Drupal) {
    ...
    Drupal.behaviors.showCurrentHours = {
        ...
        attach: function (context) {
            ...
            $elm.each(function (a, b) {
                ...
                var style = $this.data('uwm-opens-at-style');

                if (!!data.opens_next) {
                    var markup = hoursMarkup(data, style);
                    $this.html(markup);
                }
    ...
    function hoursMarkup(data, display_style) {
        ...
        if (display_style === 'times-only') {
            ...
            // "8:00 am - 5:00 pm".
                ...
                markup = uwf('{1} - {2}',
                    moment.unix(data.opens_today).format('h:mm a'),
                    moment.unix(data.closes_today).format('h:mm a')
                );
